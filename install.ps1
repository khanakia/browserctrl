...
# volt:hash 5d391a221f80
# browserctrl installer for Windows (PowerShell).
#
# Usage:
#   irm https://raw.githubusercontent.com/khanakia/browserctrl/main/install.ps1 | iex
...
if ($Version) { $base = "https://github.com/khanakia/browserctrl/releases/download/$Version" }
else          { $base = "https://github.com/khanakia/browserctrl/releases/latest/download" }
