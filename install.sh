...
# volt:hash cf2e42f6c605
# browserctrl installer for macOS / Linux.
#
# Usage:
...
if [ -n "$VERSION" ]; then
  BASE="https://github.com/khanakia/browserctrl/releases/download/${VERSION}"
else
  BASE="https://github.com/khanakia/browserctrl/releases/latest/download"
